...
import com.codedotman.drugreminder.Reminder.AlarmScheduler;
...
public class AddReminder extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener,
    ...
    private TextView mDateText, mTimeText, mRepeatTypeText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mRepeatTypeText.setText(savedRepeatNo);
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_REPEAT_NO, mRepeatTypeText.getText());
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        if (input.getText().toString().length() == 0) {
                            mRepeatNo = Integer.toString(1);
                            mRepeatTypeText.setText(mRepeatNo);
...
*/
        ...
        values.put(ReminderContract.AlarmReminderEntry.KEY_TITLE, mTitle);
        values.put(ReminderContract.AlarmReminderEntry.KEY_DATE, mDate);
        values.put(ReminderContract.AlarmReminderEntry.KEY_TIME, mTime);
        values.put(ReminderContract.AlarmReminderEntry.KEY_REPEAT, mRepeat);
        values.put(ReminderContract.AlarmReminderEntry.KEY_REPEAT_NO, mRepeatNo);
        values.put(ReminderContract.AlarmReminderEntry.KEY_REPEAT_TYPE, mRepeatType);
        values.put(ReminderContract.AlarmReminderEntry.KEY_ACTIVE, mActive);
        ...
        if (mCurrentReminderUri == null) {
            ...
            Uri newUri = getContentResolver().insert(ReminderContract.AlarmReminderEntry.CONTENT_URI, values);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mRepeatTypeText.setText(repeatNo);
